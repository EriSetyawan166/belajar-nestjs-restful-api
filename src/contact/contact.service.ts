...
export class ContactService {
    ...
    async search(user: User, request: SearchContactRequest): Promise<WebResponse<ContactResponse[]>> {
        const searchRequest: SearchContactRequest = await this.validationService.validate(ContactValidation.SEARCH, request);
    ...
    async checkContactMustExists(username: string, contacId: number): Promise<Contact> {
